...
var StickyPlaceholder = /** @class */ (function (_super) {
        ...
        _this.handleDimensionsUpdate = function (_a, stickyRect) {
            ...
            if (!_this.state.isWaitingForRecalculation &&
                ...
                _this.setState({
                    ...
                    reactViewportUtils.requestAnimationFrame(function () {
                        _this.setState({
                            isRecalculating: false,
                        });
                    });
    ...
    StickyPlaceholder.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            !this.props.disableResizing && (React.createElement(reactViewportUtils.ObserveViewport, { disableScrollUpdates: true, disableDimensionsUpdates: isRecalculating, onUpdate: this.handleDimensionsUpdate, recalculateLayoutBeforeUpdate: this.calculateSize, priority: "highest" }))));
    };
